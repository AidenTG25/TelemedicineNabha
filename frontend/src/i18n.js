...
const resources = {
  ...
  hi: {
    translation: {
      ...
      uploadError: 'फ़ाइल अपलोड में त्रुटि',
      aiAnalysisResults: 'एआई विश्लेषण परिणाम',
      summary: 'सारांश',
      keyFindings: 'मुख्य निष्कर्ष',
      recommendations: 'सिफारिशें',
      recentUploads: 'हाल ही में अपलोड की गई फ़ाइलें',
      noFilesUploaded: 'कोई फ़ाइल अभी तक अपलोड नहीं हुई',
      ...
      callInProgress: 'कॉल प्रगति पर है',
      noDoctorvailable: 'इस समय कोई डॉक्टर उपलब्ध नहीं है',
      inventory: 'सूची',
      quantity: 'मात्रा',
      price: 'मूल्य',
      expiryDate: 'समाप्ति तिथि',
      manufacturer: 'निर्माता',
      uploadHealthRecords: 'स्वास्थ्य रिकॉर्ड अपलोड करें',
      dragAndDropFiles: 'यहाँ फ़ाइलें खींचें और छोड़ें, या चयन करने के लिए क्लिक करें',
  ...
  pa: {
    translation: {
      ...
      uploadError: 'ਫਾਈਲ ਅਪਲੋਡ ਵਿੱਚ ਗਲਤੀ',
      aiAnalysisResults: 'ਏਆਈ ਵਿਸ਼ਲੇਸ਼ਣ ਨਤੀਜੇ',
      summary: 'ਸਾਰ',
      keyFindings: 'ਮੁੱਖ ਨਤੀਜੇ',
      recommendations: 'ਸੁਝਾਅ',
      recentUploads: 'ਹਾਲ ਹੀ ਵਿੱਚ ਅਪਲੋਡ ਕੀਤੀਆਂ ਫਾਈਲਾਂ',
      noFilesUploaded: 'ਹੁਣ ਤੱਕ ਕੋਈ ਫਾਈਲ ਅਪਲੋਡ ਨਹੀਂ ਹੋਈ',
      ...
      videoCall: 'ਵੀਡੀਓ ਸਲਾਹ-ਮਸ਼ਵਰਾ',
      startVideoCall: 'ਵੀਡੀਓ ਕਾਲ ਸ਼ੁਰੂ ਕਰੋ',
      endCall: 'ਕਾਲ ਖਤਮ ਕਰੋ',
      callInProgress: 'ਕਾਲ ਚੱਲ ਰਹੀ ਹੈ',
      noDoctorvailable: 'ਇਸ ਸਮੇਂ ਕੋਈ ਡਾਕਟਰ ਉਪਲਬਧ ਨਹੀਂ',
      inventory: 'ਸੂਚੀ',
      quantity: 'ਮਾਤਰਾ',
      price: 'ਕੀਮਤ',
      expiryDate: 'ਮਿਆਦ ਖਤਮ',
      manufacturer: 'ਨਿਰਮਾਤਾ',
      uploadHealthRecords: 'ਸਿਹਤ ਰਿਕਾਰਡ ਅਪਲੋਡ ਕਰੋ',
      dragAndDropFiles: 'ਫਾਈਲਾਂ ਇੱਥੇ ਖਿੱਚੋ ਅਤੇ ਛੱਡੋ, ਜਾਂ ਚੁਣਨ ਲਈ ਕਲਿੱਕ ਕਰੋ',
      healthRecords: 'ਸਿਹਤ ਰਿਕਾਰਡ',
      dropFilesHere: 'ਫਾਈਲਾਂ ਇੱਥੇ ਛੱਡੋ...',
      supportedFormats: 'ਸਮਰਥਿਤ ਫਾਰਮੈਟ',
      selectFiles: 'ਫਾਈਲਾਂ ਚੁਣੋ',
      selectedFiles: 'ਚੁਣੀਆਂ ਫਾਈਲਾਂ',
      uploadFiles: 'ਫਾਈਲਾਂ ਅਪਲੋਡ ਕਰੋ'
    }
  }
};
